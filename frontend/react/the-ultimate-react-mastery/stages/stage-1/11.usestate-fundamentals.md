...
export function ShoppingCart() {
  ...
  return (
    <div style={{ margin: "0 auto", padding: "20px" }}>
      ...
      {/* Product List */}
      <ProductList products={products} onAddCart={addToCart} />
...
![AdvancedTodoList](/images/AdvancedTodoList.png)
      ...
      >
        ...
        >
          ...
          <div style={{ marginTop: "15px" }}>
            <Bar label="Food" width="70%" color="#007bff" />
            <Bar label="Transport" width="30%" color="#28a745" />
            <Bar label="Shopping" width="50%" color="#ffc107" />
          </div>
        </div>
      </div>
    </div>
