...
<details>
  <summary>💡 Solution Phase 1</summary>
...
<details>
<summary>💡 Solution Phase 2</summary>
...
<details>
  <summary>💡 Solution Sales Analytics Pipeline (Production-ready)</summary>
...
// → name: 'Tuân Nguyễn', theme: 'dark', reputation: 0, location: 'Biên Hòa, Vietnam', ...
 ...
 * @param {Array<string | { key: string, order?: 'asc'|'desc' } | ((a:T,b:T)=>number)>} keys
 *        - Mảng các key hoặc object {key, order} hoặc hàm so sánh
 * @returns {T[]} Mảng đã được sắp xếp
 *
 * @example
 * const data = [
 ...
 * ];
 * sortByMultiple(data, ['name', {key:'age', order:'asc'}, 'score'])
 */
