...
```
Technical perfection < Working product
Pretty UI < Functional UI
Many features < Core features done well
```
...
**Q1**: "Walk me through your component architecture"
**A**: Explain hierarchy, data flow, why certain components are separated

**Q2**: "How would you add a new feature?"
**A**: Identify affected components, plan data flow, implement incrementally, test

**Q3**: "What would you refactor first?"
**A**: Filter/search logic to use proper state management

---

## 🎯 PREVIEW NGÀY MAI

**Ngày 11: useState - The Missing Piece**

Tomorrow we solve ALL the hacky solutions from today:
...
We'll refactor this project using `useState` and see how much cleaner it becomes!

**Prepare:**

- Review today's code
- Identify all the "hacks" we used
- Think about what state we need
- Get excited - this is where React really shines! 🚀
