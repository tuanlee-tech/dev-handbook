...
> Người dùng than phiền: “Form báo mật khẩu không khớp dù tôi nhập y hệt nhau!”
> Debug mãi mới phát hiện nguyên nhân: ô password có bật autocomplete, nên khi mật khẩu thay đổi, validation của ô confirm password không được chạy lại.
>
> Cách fix: mỗi khi password thay đổi thì re-validate confirm password.
> Bài học rút ra: Validation giữa nhiều field (cross-field validation) phải xử lý tất cả các thay đổi liên quan, không chỉ mỗi field đang nhập.

**Story 3: The Performance Killer Form**

> Form có 50 field nên mỗi lần gõ phím đều bị lag ~100ms.
> Profiling mới thấy nguyên nhân: mỗi onChange lại chạy regex validation cho toàn bộ 50 field.
>
> Cách fix:
>
