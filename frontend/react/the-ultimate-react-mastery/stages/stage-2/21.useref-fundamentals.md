...
| ------------------ | --------------------------------------- | --------------------------------- | ------------------------------------------------------- |
| **Re-render**      | ✅ Trigger re-render                    | ❌ KHÔNG trigger re-render        | useState: UI data<br>useRef: Non-UI data                |
| **Update timing**  | Async (batched)                         | Sync (immediate)                  | useState: Cần consistency<br>useRef: Cần instant access |
| **Purpose**        | UI state management                     | Mutable values persistence        | useState: Hiển thị lên UI<br>useRef: Internal tracking  |
