...
### 4. Server Components chính thức (không còn experimental)
...
### 5. `ref` trở thành prop thường — Không cần `forwardRef` nữa
...
### 6. Context Provider đơn giản hóa
...
### 7. Document Metadata — SEO không cần thư viện thứ 3
