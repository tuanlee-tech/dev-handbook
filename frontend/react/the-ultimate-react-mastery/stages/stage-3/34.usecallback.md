...
const CommentItem = React.memo(
  ({ comment, onLike, onReply, onEdit, onDelete, onToggleCollapse }) => {
    ...
    // Để test performance: Bật console.log này lên, bạn sẽ thấy khi click Like,
    // CHỈ CÓ comment được click bị re-render. Các comment khác đứng im.
        ...
        {!comment.isCollapsed && (
          <>
            {isEditing ? (
              ...
              <p style={{ margin: '4px 0 8px', color: '#334155' }}>
                {comment.text}
              </p>
            )}
